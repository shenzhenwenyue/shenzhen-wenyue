...
function getMixLabel(categoria, subcategoria) {
  if (categoria === 'Lululemon' && subcategoria === 'Bags')
    return 'City Bags are priced independently — min. 10 pcs (not combined with other Lululemon)'
...
function getNudgeSuffix(categoria, subcategoria) {
  if (categoria === 'Lululemon' && subcategoria === 'Bags') return 'more City Bags'
        ...
        {hasTiers && (
          <div className="mb-2 rounded-lg bg-[#FFF7F0] p-2 space-y-0.5 text-xs">
            ...
            {product.qty_tier2 && product.precio_tier2 && (
              <TierRow
                label={`${product.qty_tier2} a ${product.qty_tier3 ? product.qty_tier3 - 1 : '+'} pcs`}
            ...
            {product.qty_tier3 && product.precio_tier3 && (
              <TierRow
                label={`${product.qty_tier3} a ${product.qty_tier4 ? product.qty_tier4 - 1 : '+'} pcs`}
