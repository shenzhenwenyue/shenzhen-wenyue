    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-[#FF6A00] text-white sticky top-0 z-40 shadow-md">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-2">
            <a href="/track" className="hidden sm:flex items-center gap-1.5 bg-white/20 hover:bg-white/30 px-3 py-2 rounded-lg transition-colors text-sm font-medium">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
              </svg>
              Track Order
            </a>
            <a href="/catalog" className="flex items-center gap-2 bg-white text-[#FF6A00] font-bold px-4 py-2 rounded-lg hover:bg-orange-50 transition-colors text-sm">
              Browse Catalog
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="bg-gradient-to-br from-[#FF6A00] via-[#F05500] to-[#C23B00] text-white py-16 sm:py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="/catalog" className="inline-flex items-center justify-center gap-2 bg-white text-[#FF6A00] font-semibold px-7 py-3 rounded-lg hover:bg-orange-50 transition-colors text-sm shadow">
              Browse Full Catalog
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://wa.me/16613737977" target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-white/15 hover:bg-white/25 text-white font-medium px-7 py-3 rounded-lg transition-colors text-sm border border-white/25">
      ...
      <section className="py-12 px-4 bg-[#F5F5F5]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-6">
            <a href="/catalog" className="inline-flex items-center gap-2 bg-[#FF6A00] text-white font-semibold px-6 py-2.5 rounded-lg hover:bg-[#E55A00] transition-colors text-sm">
              View All Products
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
      ...
      <section className="py-12 px-4 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-4">
            ...
            {/* Cash App */}
            <div className="flex flex-col items-center gap-3 border border-gray-200 rounded-xl p-5 sm:p-6 hover:border-[#00D64F] hover:shadow-sm transition-all">
            ...
            {/* Zelle */}
            <div className="flex flex-col items-center gap-3 border border-gray-200 rounded-xl p-5 sm:p-6 hover:border-[#6D1ED4] hover:shadow-sm transition-all">
            ...
            {/* Alibaba */}
            <div className="flex flex-col items-center gap-3 border border-gray-200 rounded-xl p-5 sm:p-6 hover:border-[#FF6A00] hover:shadow-sm transition-all">
      ...
      <section className="bg-[#FF6A00] text-white py-14 px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <a href="/catalog" className="inline-flex items-center justify-center gap-2 bg-white text-[#FF6A00] font-semibold px-8 py-3 rounded-lg hover:bg-orange-50 transition-colors text-sm shadow">
            Browse Catalog
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
          ...
          <a href="https://wa.me/16613737977" target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 bg-white/15 hover:bg-white/25 text-white font-medium px-8 py-3 rounded-lg transition-colors text-sm border border-white/25">
            <svg className="w-4 h-4 shrink-0" fill="currentColor" viewBox="0 0 24 24">
              <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z" />
            </svg>
            WhatsApp Us
